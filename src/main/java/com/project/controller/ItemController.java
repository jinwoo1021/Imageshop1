...
public class ItemController {
	...
	//메시지를 처리할 Message Source 필드로 선언함
	@Autowired
	...
	public String register(Item item, RedirectAttributes rttr) throws Exception {
		...
		MultipartFile picturFile = item.getPicture();
		MultipartFile previewFile = item.getPreview();
		
		String createdPictureFilename = uploadFile(picturFile.getOriginalFilename(), picturFile.getBytes());
	...
	@PreAuthorize("hasRole('ROLE_ADMIN')")
	public String modify (Item item, RedirectAttributes rttr) throws 
	Exception {
	...
	public String buy(Integer itemId, RedirectAttributes rttr, Authentication authentication)
	throws Exception {
		...
		String message = messageSource.getMessage
				("item.purchaseComplete", null,Locale.KOREAN);
